...
{
	static const std::array<glm::vec2, 4> offsets = { glm::vec2( 0, size.y / 2.f ),
	...
	{
		sprites[static_cast<size_t>( state )]->Render( position + offsets[static_cast<size_t>( eBrickLocation )], size / 2.f, rotation );
	}
}
